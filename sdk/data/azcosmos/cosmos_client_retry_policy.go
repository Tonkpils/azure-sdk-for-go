...
func (p *clientRetryPolicy) Do(req *policy.Request) (*http.Response, error) {
	...
	for {
		...
		resolvedEndpoint := p.gem.ResolveServiceEndpoint(retryContext.retryCount, o.resourceType, o.isWriteOperation, retryContext.useWriteEndpoint, o.excludeRegions)
